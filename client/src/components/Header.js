...
const Header = () => {
  ...
  return (
    <div className="flex w-full p-4 items-center justify-center gap-10 text-[#333] text-[18px] font-medium">
      ...
      {localStorage.getItem("token") && (
        <div
          className="w-[30%] flex items-end justify-end "
        ...
        >
          ...
          {isMenu && (
            <motion.div
              ...
              exit={{ opacity: 0, y: 50 }}
              className="absolute z-10 top-[50px] right-[80px] w-[150px] p-4 gap-4 shadow-lg rounded-lg backdrop-blur-sm flex flex-col bg-gray-100"
            >
